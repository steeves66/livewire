    ...
    <div class="max-w-md w-full">
      ...
      <form class="mt-8" wire:submit.prevent="save">
        ...
        <div class="rounded-md shadow-sm">
          <div>
            <input wire:model.lazy="name" aria-label="Email address" name="name" type="text" 
              ...
              placeholder="One name for your call">
            @error('name')
            <p class="text-sm text-red-500 text-center">{{$message}}</p>
            @enderror
          </div>
          <div class="mt-2">
            <input wire:model.lazy="email" aria-label="Email address" name="email" type="email" 
              class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md rounded-b-md focus:outline-none focus:shadow-outline-blue focus:border-blue-300 focus:z-10 sm:text-sm sm:leading-5"
          ...
          <div class="-mt-px">
            <input wire:model.lazy="password" aria-label="Password" name="password" type="password"
